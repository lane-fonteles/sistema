...
<div id="corpo-form-cad">
    ...
    <form method="POST">
        ...
        <input type="text" name="codigo" placeholder="Código" maxlength="30"/>
...
if(isset($_POST['nome'])):
    ...
    $telefone = addslashes($_POST['codigo']);
    $email = addslashes($_POST['email']);
    $senha = addslashes($_POST['senha']);
    $conf_senha = addslashes($_POST['conf_senha']);

    if(!empty($nome) && !empty($codigo) && !empty($email) && !empty($senha) && !empty($conf_senha)):
        ...
        if($u-> msgERRO == ""):
            ...
            if($senha==$conf_senha):
                ...
                if($u->cadastrar($nome, $codigo, $email, $senha)):
